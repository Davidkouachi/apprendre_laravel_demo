            ...
            <div class="card-inner card-inner-lg">
                <div class="nk-block-head">
                    <div class="nk-block-head-content">
                        <h4 class="nk-block-title">Mise a jour</h4>
                    </div>
                </div>
                <form id="registre" class="" action="/update_recherche" method="post">
                    @csrf
                    <div class="form-group">
                        <label class="form-label">Nom et Prénoms</label>
                        <div class="form-control-wrap">
                            <input autocomplete="off" type="text" class="form-control form-control-md" name="nom" id="nom" placeholder="Entrer votre Nom et prénoms" value="{{$liste->name}}">
                            <input style="display: none" type="text" name="id" value="{{$liste->id}}">
                        </div>
                    </div>
                    <div class="row g-gs mb-4" >
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input autocomplete="off" type="email" class="form-control form-control-md" name="email" id="email" placeholder="Entrer votre email" value="{{$liste->email}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap mb-2">
                                    <input autocomplete="off" name="tel" id="tel" type="tel" class="form-control form-control-md" placeholder="Entrer votre contact" maxlength="10" value="{{$liste->tel}}">
                                </div>
                                <script>
                    ...
                    <div class="form-group row g-gs">
                        ...
                        <div class="col-lg-6">
                            <button type="submit" class="btn btn-lg btn-dim btn-outline-primary btn-block">
